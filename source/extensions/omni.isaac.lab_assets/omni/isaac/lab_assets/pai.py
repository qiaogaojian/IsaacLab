...
PAI_CFG = ArticulationCfg(
    ...
    actuators={
        "legs": ImplicitActuatorCfg(
            ...
            velocity_limit=10.0,
            stiffness={
                ".*_hip_yaw_joint":     30.0,  # 40.0,
                ".*_hip_roll_joint":    720.0,  # 80.0,
                ".*_hip_pitch_joint":   70.0,  # 15.0,
                ".*_knee_joint":        70,  # 40.0,
                ".*_ankle_pitch_joint": 25,  # 80.0,
                ".*_ankle_roll_joint":  60,  # 15.0,
            },
            damping={
                ".*_hip_yaw_joint":     0.30,  # 0.125,
                ".*_hip_roll_joint":    6.4,  # 0.125,
                ".*_hip_pitch_joint":   0.8,  # 0.125,
